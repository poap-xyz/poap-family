...
/**
 * @param {PropTypes.InferProps<EventButtonMomentsView.propTypes>} props
 */
...
EventButtonMomentsView.propTypes = {
  event: PropTypes.shape(DropProps).isRequired,
}

/**
 * @param {PropTypes.InferProps<EventButtonMomentsPublish.propTypes>} props
 */
...
EventButtonMomentsPublish.propTypes = {
  event: PropTypes.shape(DropProps).isRequired,
}

/**
 * @param {PropTypes.InferProps<EventButtonMoments.propTypes>} props
 */
