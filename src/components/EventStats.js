...
import { DropMetricsProps, DropProps } from 'models/drop'
...
/**
 * @param {PropTypes.InferProps<EventStats.propTypes>} props
 */
function EventStats({ event, collectors, cachedTs, metrics }) {
  const stats = {
...
EventStats.propTypes = {
  ...
  collectors: PropTypes.number.isRequired,
  cachedTs: PropTypes.number,
  metrics: PropTypes.shape(DropMetricsProps),
}
